...
public class TaskDeleteService {
	...
	public TaskDeleteService(TaskOwnershipGuard ownershipGuard, CtHealthReportTaskService taskService,
	 ...
	 */
	public void delete(String taskId, String currentUserId, String currentCompanyId) {
