 ...
 * </p>
 * <p>
 * <b>展示上限</b>：每个维度 recommendableFoodList ∪ displayOnlyFoodList 必须落在 3~8 种
 * （需求 §7），由 ContentConstantsReviewTest 契约守护。2026-09-04 裁减
 * IRON（红枣）、CALCIUM（虾皮）、PROTEIN（瘦牛肉、黄豆、牛奶）以满足上限，待内容/医务审核确认，
 * 台账见内容常量证据审核台账V1。
 * </p>
 */
public final class NutritionContents {
	...
	public static final NutritionRule IRON = new NutritionRule(NutritionKey.IRON, "铁",
			Arrays.asList("猪肝", "鸡肝", "鸭血", "猪血", "瘦牛肉", "羊肉"), Arrays.asList("菠菜", "黑木耳"),
	...
	public static final NutritionRule CALCIUM = new NutritionRule(NutritionKey.CALCIUM, "钙",
			Arrays.asList("牛奶", "酸奶", "奶酪", "石膏豆腐"), Arrays.asList("小油菜", "芥蓝", "北豆腐", "南豆腐"),
	...
	public static final NutritionRule PROTEIN = new NutritionRule(NutritionKey.PROTEIN, "蛋白质",
			Arrays.asList("鸡胸肉", "鸡腿肉", "瘦猪肉", "鱼肉", "虾仁", "鸡蛋", "北豆腐", "南豆腐"),
	...
	public static final NutritionRule VITAMIN_D = new NutritionRule(NutritionKey.VITAMIN_D, "维生素D",
	...
	public static final NutritionRule VITAMIN_B12 = new NutritionRule(NutritionKey.VITAMIN_B12, "维生素B12",
	...
	public static final NutritionRule FOLATE = new NutritionRule(NutritionKey.FOLATE, "叶酸",
	...
	public static final NutritionRule DIETARY_FIBER = new NutritionRule(NutritionKey.DIETARY_FIBER, "膳食纤维",
	...
	public static final NutritionRule ZINC = new NutritionRule(NutritionKey.ZINC, "锌", Arrays.asList("瘦牛肉", "猪肝", "南瓜子"),
	...
	public static final NutritionRule POTASSIUM = new NutritionRule(NutritionKey.POTASSIUM, "钾",
