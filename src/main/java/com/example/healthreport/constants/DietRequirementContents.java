...
/**
 * 饮食注意内容常量。
 * <p>本维度由 LLM-B 离线打标，<b>当前只产生 REJECT</b>：本类中没有任何可触发推荐的规则，
 * 因此 LLM-B 的 verdict 枚举生成结果是 REJECT-only。</p>
 * <p>当前全部 {@code reviewStatus = DRAFT}，规则不生效。</p>
 */
public final class DietRequirementContents {
    ...
    /** LOW_FAT。 */
    public static final DietRequirementRule LOW_FAT = new DietRequirementRule(
            DietRequirementKey.LOW_FAT,
            Arrays.asList(
                    "鸡胸肉",
                    "鱼肉",
                    "虾仁",
            ...
            Arrays.asList(
                    ...
                    "酥皮点心"),
            Arrays.asList(
                    "蒸、煮、炖、白灼、凉拌；避免煎、炸、干煸"),
            Collections.<String>emptyList(),
            "", ReviewStatus.DRAFT);

    /** LOW_SODIUM。 */
    public static final DietRequirementRule LOW_SODIUM = new DietRequirementRule(
            DietRequirementKey.LOW_SODIUM,
            Arrays.asList(
                    "新鲜蔬菜",
                    "新鲜肉类",
                    "鲜鱼"),
    ...
    public static final DietRequirementRule LOW_ADDED_SUGAR = new DietRequirementRule(
            DietRequirementKey.LOW_ADDED_SUGAR,
            Collections.<String>emptyList(),
            Arrays.asList(
                    "含糖饮料",
                    "蜜饯",
    ...
    /** LOW_PURINE。 */
    public static final DietRequirementRule LOW_PURINE = new DietRequirementRule(
            ...
            Arrays.asList(
                    ...
                    "啤酒"),
            Arrays.asList(
                    "肉类先焯水弃汤再烹调（只降低嘌呤，不能把高嘌呤食材翻转为推荐）"),
            Arrays.asList(
                    "在心、肾功能正常且无液体限制的前提下，保证充足饮水"),
            "", ReviewStatus.DRAFT);

    /** LOW_CHOLESTEROL。 */
    public static final DietRequirementRule LOW_CHOLESTEROL = new DietRequirementRule(
            DietRequirementKey.LOW_CHOLESTEROL,
            Arrays.asList(
                    "深海鱼",
                    "去皮禽肉",
                    "燕麦",
    ...
    /** LOW_CALORIE。 */
    public static final DietRequirementRule LOW_CALORIE = new DietRequirementRule(
    ...
    /** HIGH_FIBER。 */
    public static final DietRequirementRule HIGH_FIBER = new DietRequirementRule(
    ...
    /** LIMIT_ALCOHOL。 */
    public static final DietRequirementRule LIMIT_ALCOHOL = new DietRequirementRule(
    ...
    /** LIGHT_DIET。 */
    public static final DietRequirementRule LIGHT_DIET = new DietRequirementRule(
            DietRequirementKey.LIGHT_DIET,
            Arrays.asList(
                    "北豆腐",
                    "南豆腐",
                    "冬瓜",
