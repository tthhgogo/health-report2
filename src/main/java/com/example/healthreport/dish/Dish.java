 ...
 * 食堂只读菜品快照。
 * <p>
 * 只包含离线打标与模块四所需的公开菜品字段，不含用户或健康数据。
 * </p>
 */
@Getter
public final class Dish {
	...
	/** 创建不可变的当日在架菜品快照。 */
	public Dish(String companyId, long dishId, String dishName, List<DishIngredient> ingredientList) {
		if (companyId == null || companyId.length() == 0 || dishId <= 0L || dishName == null
				|| ingredientList == null) {
