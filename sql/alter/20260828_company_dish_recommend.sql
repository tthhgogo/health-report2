...
ALTER TABLE ct_health_report_task
  ADD COLUMN company_id VARCHAR(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '归属企业ID，创建任务时从创建请求体固化，模块四据此选择企业菜品集合' AFTER task_id;
...
ALTER TABLE ct_health_report_task MODIFY COLUMN company_id VARCHAR(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '归属企业ID，创建任务时从创建请求体固化，模块四据此选择企业菜品集合';
